...
public class MainActivity extends ActionBarActivityView implements IMainMenuView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //MainGameClass mainGameClass = MainGameClass.getInstance();
        //dbOpenHelper.dropTables(MainGameClass.getDatabase());
        MainGameClass.getInstance().setDbOpenHelper(dbOpenHelper);
        if (MainGameClass.getDatabase().getPath() != null)
        {
